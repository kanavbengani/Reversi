...
public class ReversiControllerTests {
  ...
  public void initTest() {
    ...
    // Mock model to test player and view are correctly publishing to model through controller.
    new Controller(mockModel, this.player,
        view, PieceColor.BLACK);
    
    // Mock player to test model is correctly publishing to player and view through controller.
